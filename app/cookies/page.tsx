        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
            <div className="prose prose-lg max-w-none">
                ...
                <table className="min-w-full border border-gray-200 rounded-lg overflow-hidden">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    <tr>
                      ...
                      <td className="px-4 py-3 text-sm text-gray-700">Google Analytics - distinguishes users</td>
                    ...
                    <tr>
                      ...
                      <td className="px-4 py-3 text-sm text-gray-700">Google Analytics - throttles requests</td>
                      <td className="px-4 py-3 text-sm text-gray-700">1 minute</td>
                    </tr>
                    <tr>
                      <td className="px-4 py-3 text-sm text-gray-700">session_id</td>
                      <td className="px-4 py-3 text-sm text-gray-700">Maintains your session state</td>
              ...
              <p className="text-gray-600 mb-4">Here&apos;s how to manage cookies in popular browsers:</p>
              <ul className="list-disc list-inside text-gray-600 mb-4 space-y-2">
                <li>
                  <a
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-4">
                <p className="text-gray-700">
                  <strong>Email:</strong>{' '}
                  <a href="mailto:hello@bondtype.com" className="text-blue-600 hover:underline">
                    hello@bondtype.com
                  </a>
                </p>
              </div>
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-600 mb-4">Ready to understand your attachment style?</p>
            <Link
              href="/assessment"
